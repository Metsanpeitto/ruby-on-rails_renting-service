...
#   Character.create(name: 'Luke', movie: movies.first)
 ...
 user  = User.create(name:"administrator",email:"as@as.com",password:"123456",password_confirmation:"123456",role:"admin")
 ...
 Item.create([{name:"Big boat",description:"It is amazing",image:"https://i.imgur.com/SZJIKne.png",price:300,color:"blue", user_id: user.id},
    ...
    {name:"Small boat",description:"It is small, but amazing",image:"https://i.imgur.com/RdEZTBM.png" ,price:100,color:"green", user_id: user.id}
    ])
